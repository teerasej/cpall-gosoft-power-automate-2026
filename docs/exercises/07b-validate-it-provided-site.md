...
> **💡 Analogy:** IT เตรียมตู้เอกสารไว้แล้ว งานของเราคือตรวจป้ายชื่อ หาเฉพาะถาดของเรา และลองใช้กุญแจของตนเอง
...
5. หากเปิด site หรือสร้างโฟลเดอร์ไม่ได้ ให้หยุดและแจ้งวิทยากร ไม่ต้องขอใช้ connection ของบุคคลอื่น
