...
> **🔗 SharePoint ของลูกค้า:** [เปิด CPAll Microsoft AI Agent Platform](https://cpallgroup.sharepoint.com/sites/MicrosoftAIAgentPlatform) — ผู้เรียนต้องลงชื่อเข้าใช้ด้วยบัญชี CPAll ที่ได้รับสิทธิ์ ลิงก์นี้ใช้เพื่อเข้าถึง site เท่านั้น ไม่ได้ยืนยันสิทธิ์หรือความพร้อมสำหรับกิจกรรม
